...
?>
    <main>
        <div class="bg-image d-flex justify-content-center align-items-flex-start banner"
            style=" background-image: url('images/banner1.jpg'); background-size: cover; background-position:bottom; background-color: darkslategray; background-blend-mode: multiply; height: 80vh; padding: 8rem 0">
